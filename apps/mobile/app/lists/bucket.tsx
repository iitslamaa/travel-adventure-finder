...
export default function BucketListScreen() {
  ...
  const { bucketIsoCodes, toggleBucket, loading: authLoading } = useAuth();
        ...
        {isLoading ? (
          ...
          <View style={[styles.emptyCard, { backgroundColor: colors.paper, borderColor: colors.border }]}>
            ...
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
              Tap the bookmark icon on a country to add it here.
            </Text>
          </View>
        ) : (
      ...
      >
        <ScrapbookBackground overlay={0}>
          ...
          <View style={[styles.modalScreen, { backgroundColor: 'transparent' }]}>
            ...
            <TitleBanner title="Edit Bucket List" />
            ...
            <ScrapbookCard innerStyle={[styles.editorCard, { backgroundColor: `${colors.card}F2` }]}>
              <Text style={[styles.editorCopy, { color: colors.textSecondary }]}>
                Search and tap countries to add or remove them from your bucket list.
              </Text>
              ...
              >
                {filteredCountries.map(country => {
                  const selected = bucketIsoCodes.includes(country.iso2);
                  return (
                    <Pressable
                      key={country.iso2}
                      onPress={() => toggleBucket(country.iso2)}
                      style={[
                        styles.editorRow,
                        {
